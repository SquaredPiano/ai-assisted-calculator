...
public class CalculatorFacadeImplTest {
    ...
    public void testPerformOperation_Add() {
        double result = calculatorFacade.performOperation(1, 5, 3);
        assertEquals(8, result);
    }

    @Test
    public void testPerformOperation_Subtract() {
        double result = calculatorFacade.performOperation(2, 8, 3);
        assertEquals(5, result);
    }

    @Test
    public void testPerformOperation_Multiply() {
        double result = calculatorFacade.performOperation(3, 4, 3);
        assertEquals(12, result);
    }

    @Test
    public void testPerformOperation_Divide() {
        double result = calculatorFacade.performOperation(4, 10, 2);
        assertEquals(5, result);
    }

    @Test
    public void testPerformTrigonometricOperation_Sine() {
        double result = calculatorFacade.performTrigonometricOperation(5, 30);
        assertEquals(0.5, result, 0.001);
    }

    @Test
    public void testPerformTrigonometricOperation_Cosine() {
        double result = calculatorFacade.performTrigonometricOperation(6, 60);
        assertEquals(0.5, result, 0.001);
    }

    @Test
    public void testPerformTrigonometricOperation_Tangent() {
        double result = calculatorFacade.performTrigonometricOperation(7, 45);
